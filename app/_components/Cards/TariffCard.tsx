    ...
    return (
        <div
            ...
            className={`relative cursor-pointer rounded-3xl px-5 py-6 bg-[#282E33] transition-all duration-300 text-white flex flex-col justify-start col-span-1 overflow-hidden
                ...
                shadow-lg`}
        >
            <div className="flex justify-between absolute top-0 left-0 w-full z-10 pt-2">
            ...
            <div className="flex flex-col w-full pt-0">
                <div className={`flex flex-col w-full items-start lg:items-center lg:flex-col justify-start`}>

                    <div className="flex flex-col items-start pr-4 lg:items-center lg:pr-0 lg:pt-3">
